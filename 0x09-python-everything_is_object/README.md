...
* **14. List append**
OAOAOA  * [14-answer.txt](./14-answer.txt): What does this script print?
```
l1 = [1, 2, 3]
l2 = l1
l1.append(4)
...
OAOAOA* **15. List add**
OAOAOA  * [15-answer.txt](./15-answer.txt): What does this script print?
```
OAOAOAl1 = [1, 2, 3]
l2 = l1
l1 = l1 + [4]
...
OAOAOA```
OAOAOA
OAOAOA* **17. List incrementation**
...
l1 = [1, 2, 3]
l2 = [4, 5, 6]
OBOBOBassign_value(l1, l2)
print(l1)
OBOBOB```

OBOBOBOBOBOB* **19. Copy a list object**
...
OBOBOB  * [26-answer.txt](./26-answer.txt): What does this script print?
OBOBOB```
a = ()
OBOBOBb = ()
a is b
